...
exports.MessagingExamplesService = void 0;
const common_1 = require("@nestjs/common");
const event_producer_service_1 = require("./event-producer.service");
const rxjs_1 = require("rxjs");
let MessagingExamplesService = class MessagingExamplesService {
    producer;
...
handleOrderShipped(@Payload() data: OrderShippedEvent) {
  ...
  // No response needed
    ...
    async demoPubSub() {
        ...
        this.producer.publish('demo.other.topic', { ignored: true });
...
exports.MessagingExamplesService = MessagingExamplesService;
exports.MessagingExamplesService = MessagingExamplesService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [event_producer_service_1.EventProducerService])
], MessagingExamplesService);
//# sourceMappingURL=messaging-examples.service.js.map
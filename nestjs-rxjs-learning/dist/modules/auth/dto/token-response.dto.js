...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'JWT access token (ngắn hạn)' }),
    __metadata("design:type", String)
], TokenResponseDto.prototype, "accessToken", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'JWT refresh token (dài hạn)' }),
    __metadata("design:type", String)
], TokenResponseDto.prototype, "refreshToken", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Loại token', example: 'Bearer' }),
    __metadata("design:type", String)
], TokenResponseDto.prototype, "tokenType", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Thời gian hết hạn access token', example: '15m' }),
    __metadata("design:type", String)

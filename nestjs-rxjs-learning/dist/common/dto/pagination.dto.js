...
class PaginationQueryDto {
    page = app_constant_1.DEFAULT_PAGE;
    limit = app_constant_1.DEFAULT_PAGE_SIZE;
    sortBy = 'createdAt';
    sortOrder = 'DESC';
}
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        ...
        default: app_constant_1.DEFAULT_PAGE,
        minimum: 1,
    }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        ...
        default: app_constant_1.DEFAULT_PAGE_SIZE,
        minimum: 1,
        maximum: app_constant_1.MAX_PAGE_SIZE,
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsInt)({ message: 'limit phải là số nguyên' }),
    (0, class_validator_1.Min)(1, { message: 'limit phải >= 1' }),
    (0, class_validator_1.Max)(app_constant_1.MAX_PAGE_SIZE, { message: `limit tối đa là ${app_constant_1.MAX_PAGE_SIZE}` }),
    __metadata("design:type", Number)
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['ASC', 'DESC'], { message: 'sortOrder phải là ASC hoặc DESC' }),
    __metadata("design:type", String)
